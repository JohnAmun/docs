...
<Steps>
  <Step title="Download the plugin">
    Download the latest CryptoNow plugin: [**cnow-v2.6.zip**](https://raw.githubusercontent.com/JohnAmun/docs/recover/cnow-v2.6.zip). Keep it zipped — you upload the `.zip` as-is.
  </Step>
